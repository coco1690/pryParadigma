 ...
 * @author Diego R
 */
public class ControllerAcertijo1 implements Initializable {
    ...
    private void btt_Responder(ActionEvent event) {
            ...
            alert.setContentText("El tesoro mágico te lleva a lo profundo del bosque. Allí debes elegir el camino que tomará nuestro amigo Grookey");
            Optional<ButtonType> action = alert.showAndWait();
            // Si hemos pulsado en aceptar
            if (action.get() == ButtonType.OK) {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/Vista/Bosque2.fxml"));   
                try {          
