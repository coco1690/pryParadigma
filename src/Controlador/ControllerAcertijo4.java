 ...
 * @author Diego R
 */
public class ControllerAcertijo4 implements Initializable {
    ...
    private void btt_Responder(ActionEvent event) {
            ...
            alert.setContentText("El Muñeco de Nieve Mágico te Llevará a un Lugar Calido. Allí debes elegir el camino que tomará nuestro amigo Grookey");
            Optional<ButtonType> action = alert.showAndWait();
            // Si hemos pulsado en aceptar
            if (action.get() == ButtonType.OK) {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/Vista/Desierto1.fxml"));   
                try {          
