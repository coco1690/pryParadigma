 ...
 * @author Diego R
 */
public class ControllerAcertijo6 implements Initializable {
    ...
    private void btt_Responder(ActionEvent event) {
            ...
            alert.setContentText("El Oasis te permite beber de su agua. Al beber de esta Grookey dormira por unos minutos y cuando despierte estarás en casa");
            Optional<ButtonType> action = alert.showAndWait();
            // Si hemos pulsado en aceptar
            if (action.get() == ButtonType.OK) {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/Vista/Fin.fxml"));   // FIN
                try {          
