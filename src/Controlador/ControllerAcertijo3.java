 ...
 * @author Diego R
 */
public class ControllerAcertijo3 implements Initializable {
    ...
    private void btt_Responder(ActionEvent event) {
            ...
            alert.setContentText("El tesoro mágico te lleva a un lugar MUCHO MÁS FRIO!. Allí debes elegir el camino que tomará nuestro amigo Grookey");
            ...
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/Vista/Nieve2.fxml"));   
                try {          
                    ...
                    stageb1.close();
                    stage.show();
                    System.out.println("Abre ventana Nieve_3");         
