 ...
 * @author Diego R
 */
public class ControllerNieve2 implements Initializable {
    ...
    private void btt_ruta1(ActionEvent event) {
        FXMLLoader loader = new FXMLLoader(getClass().getResource("/Vista/Nieve2_1.fxml"));              
        try {          
    ...
    private void btt_ruta2(ActionEvent event) {
        FXMLLoader loader = new FXMLLoader(getClass().getResource("/Vista/Nieve2_2.fxml"));              
        try {          
            Parent root = loader.load();
            Scene scene = new Scene(root);
            Stage stage = new Stage();
    ...
    private void btt_ruta3(ActionEvent event) {
           FXMLLoader loader = new FXMLLoader(getClass().getResource("/Vista/Acertijo4.fxml"));              
        try {          
            Parent root = loader.load();
            Scene scene = new Scene(root);
            Stage stage = new Stage();
