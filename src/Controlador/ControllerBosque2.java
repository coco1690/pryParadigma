 ...
 * @author Diego R
 */
public class ControllerBosque2 implements Initializable {
    ...
    private void btt_ruta1(ActionEvent event) {
        FXMLLoader loader = new FXMLLoader(getClass().getResource("/Vista/Bosque2_1.fxml"));              
        try {          
    ...
    private void btt_ruta2(ActionEvent event) {
        FXMLLoader loader = new FXMLLoader(getClass().getResource("/Vista/Acertijo2.fxml"));              
        try {          
            Parent root = loader.load();
            Scene scene = new Scene(root);
            Stage stage = new Stage();
    ...
    private void btt_ruta3(ActionEvent event) {
           FXMLLoader loader = new FXMLLoader(getClass().getResource("/Vista/Bosque2_2.fxml"));              
        try {          
            Parent root = loader.load();
            Scene scene = new Scene(root);
            Stage stage = new Stage();
